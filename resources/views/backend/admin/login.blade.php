...
<body>
	...
	<div class="sign section--bg" data-bg="{{asset('public/backend/img/section/section.jpg')}}">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="sign__content">
						<!-- authorization form -->
						<form action="{{URL::to('/login-admin')}}" method="POST" class="sign__form">
                            @csrf
							...
							<div class="sign__group">
								<input type="text" name="admin_email" class="sign__input" placeholder="Email">
							</div>

							<div class="sign__group">
								<input type="password" name="admin_password" class="sign__input" placeholder="Mật khẩu">
							</div>
							...
							<span class="sign__text">Bạn chưa có tài khoản? <a href="{{url('/register')}}">Đăng ký!</a></span>

							<span class="sign__text"><a href="{{url('/reset-password')}}">Quên mật khẩu?</a></span>
						</form>
